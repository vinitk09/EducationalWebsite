  ...
  return (
    <div className="bg-primary" id="first-section">
      <div className="container mx-auto lg:max-w-screen-xl md:max-w-screen-md pt-64 px-4">
        <div className="grid grid-cols-1 gap-y-10 gap-x-16 sm:grid-cols-2 lg:grid-cols-12 xl:gap-x-8">
          <div className='col-span-4'>
            ...
            <h3 className='text-white text-lg font-medium leading-9 mb-4 lg:mb-20 mt-5'> Level up your skills, and get dream <br /> job with passion. </h3>
          ...
          <div className='col-span-4'>
            ...
            <div className="relative text-white focus-within:text-white flex flex-row-reverse">
              <input type="Email address" name="q" className="py-4 text-sm w-full text-white bg-white/15 rounded-md pl-4 focus:outline-none bg-emailbg focus:text-white" placeholder="Your email address" autoComplete="off" />
      ...
      <div className='py-8 px-4'>
        <h3 className='text-center text-white/60'>@2025 - All Rights Reserved by <Link href="https://adminmart.com/" target="_blank" className="hover:text-white"> GetNextJs Templates.com</Link></h3>
      </div>
